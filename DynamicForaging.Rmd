...
if(newModel){
  system.time(jagM<-jags.parallel(model.file = "Bayesian/Multi_RW.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=1000,n.burnin=800,n.thin=2,DIC=FALSE))
}
...
data.frame(str_match(a$par,"(\\w+)\\[(\\d+),(\\d+),(\\d+)]"))[,3:5]
