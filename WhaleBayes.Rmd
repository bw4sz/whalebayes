...
dat<-data.frame(cell=1:ncell(r),occ,beh)
```
...
system.time(jagM<-jags.parallel(model.file = "Bayesian/Intercept.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=20000,n.burnin=19000,n.thin=1,DIC=FALSE))
...
true_state<-data.frame(parameter=c("phi","rho"),value=c(phi,rho))
...
system.time(jagM<-jags.parallel(model.file = "Bayesian/Env.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=50000,n.burnin=49000,n.thin=1,DIC=FALSE))
...
system.time(jagM<-jags.parallel(model.file = "Bayesian/Env2.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=50000,n.burnin=45000,n.thin=4s,DIC=FALSE))
