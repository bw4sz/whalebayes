...
system.time(jagM<-jags.parallel(model.file = "Bayesian/Env.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=40000,n.burnin=35000,n.thin=1,DIC=FALSE))
...
system.time(jagM<-jags.parallel(model.file = "Bayesian/Env2.jags",data=data,n.chains=2,parameters.to.save=pt,n.iter=20000,n.burnin=15000,n.thin=4,DIC=FALSE))
